...
class RpcConnection extends BaseConnection implements ConnectionInterface
{
    ...
    public function reconnect(): bool
    {
        ...
        if ($result === false) {
            ...
            $client->close();
            throw new ClientException('Connect to server failed. ' . $client->errMsg . ' # ' . encode([$host, $port, $connectTimeout, SwooleCo::getCid(), posix_getpid(), $client->errCode]), $client->errCode);
        }
